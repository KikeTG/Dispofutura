...
# Última modificación: 2024-02-21 19:34:51
...
carpeta_destino_principal = os.path.join(user_home_dir, 'Inchcape', 'Archivo Base Dispo')
...
# archivo_stock_tiendas3 = next((f for f in os.listdir(ruta_carpeta_seleccionada) if "Consolidado" in f and 'semana' in f), None)
...
# else:
#     print(f"No se encontró ningún archivo con 'Stock CONSOLIDADO' en su nombre en la carpeta {carpeta_mas_cercana}.")
...
fecha_referencia = datetime.datetime.now().replace(day=22)
