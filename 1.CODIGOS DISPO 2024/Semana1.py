...
# Última modificación: 2024-03-07 14:17:08
...
archivo_stock_tiendas3 = next((f for f in os.listdir(ruta_carpeta_seleccionada) if "onsolidado" in f and '4' in f), None)
...
try:
    ...
    if "Worksheet named 'Base' not found" in str(e):
        try:
            ...
            df = pd.read_excel(ruta_destino_otb, sheet_name="Base B", usecols="A:B, D:I, K:L, N, CX, CY, ER, EU, M, ET, DM:DN", skiprows=1)
        except FileNotFoundError:
            print("El archivo especificado no fue encontrado.")
        except ValueError:
            print("Ni la hoja 'Base' ni la hoja 'Base b' se encontraron en el archivo.")
    else:
