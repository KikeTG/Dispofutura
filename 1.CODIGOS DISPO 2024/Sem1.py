...
# Última modificación: 2024-03-30 10:05:15
...
# # Paso 1: Identificar las columnas que comienzan con "Sem" en ambos DataFrames
# cols_semana_weekly_values = [col for col in weekly_values_df.columns if col.startswith('Sem')]
# cols_semana_weekly_values_modificado = [col for col in weekly_values_df_modificado.columns if col.startswith('Sem')]

# # Paso 2: Encontrar las columnas en weekly_values_df_modificado que deben ser retenidas
# cols_a_retener = set(cols_semana_weekly_values_modificado) - set(cols_semana_weekly_values)

# # Paso 3: Preparar weekly_values_df_modificado, manteniendo solo las columnas a retener (y 'Material')
# cols_finales = list(cols_a_retener) + ['Material']  # Asegúrate de incluir otras columnas necesarias para el merge
# weekly_values_df_modificado = weekly_values_df_modificado[cols_finales]
...
weekly_values_df
weekly_values_df.columns
# weekly_values_df.rename(columns={'Sem 14 (24)_y': 'Sem 14 (24)'}, inplace=True)
import datetime
import numpy as np
import pandas as pd
...
merged_df2.columns
nombre_columna_semana_siguiente
nombre_columna_semana_nueva
#46 SEMANAS ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
