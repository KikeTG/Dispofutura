...
# Última modificación: 2024-02-29 11:27:35
...
try:
    ...
    df_transito_original = pd.read_excel(ruta_destino_stock3, sheet_name='Sheet1', usecols='A:P')
except Exception as e:
    # Si falla, imprime un mensaje de advertencia y carga el archivo con el nombre de hoja 'Sheet1'
    print(f"No se pudo cargar el archivo con el nombre de hoja 'Sheet'. Error: {e}")
    try:
...
fecha_referencia = fecha_actual.replace(day=26)
...
fecha_referencia = datetime.datetime.now().replace(day=26)
